...
void Character::_bind_methods() {
	// === 枚举绑定 ===
	// CharacterState
	BIND_ENUM_CONSTANT(CHARACTER_STATE_NONE);
	BIND_ENUM_CONSTANT(CHARACTER_STATE_ALIVE);
	BIND_ENUM_CONSTANT(CHARACTER_STATE_MOVING);
	BIND_ENUM_CONSTANT(CHARACTER_STATE_ATTACKING);
	BIND_ENUM_CONSTANT(CHARACTER_STATE_CASTING);
	BIND_ENUM_CONSTANT(CHARACTER_STATE_STUNNED);
	BIND_ENUM_CONSTANT(CHARACTER_STATE_SILENCED);
	BIND_ENUM_CONSTANT(CHARACTER_STATE_ROOTED);
	BIND_ENUM_CONSTANT(CHARACTER_STATE_INVINCIBLE);
	BIND_ENUM_CONSTANT(CHARACTER_STATE_INVISIBLE);

	// DamageType
	BIND_ENUM_CONSTANT(DAMAGE_TYPE_PHYSICAL);
	BIND_ENUM_CONSTANT(DAMAGE_TYPE_MAGICAL);
	BIND_ENUM_CONSTANT(DAMAGE_TYPE_TRUE);
	BIND_ENUM_CONSTANT(DAMAGE_TYPE_PURE);

	// Faction
	BIND_ENUM_CONSTANT(FACTION_NEUTRAL);
	BIND_ENUM_CONSTANT(FACTION_FRIENDLY);
	BIND_ENUM_CONSTANT(FACTION_HOSTILE);
	...
	ADD_PROPERTY(PropertyInfo(Variant::STRING_NAME, "character_name"), "set_character_name", "get_character_name");

	ClassDB::bind_method(D_METHOD("set_faction", "faction"), &Character::set_faction);
	ClassDB::bind_method(D_METHOD("get_faction"), &Character::get_faction);
	ADD_PROPERTY(PropertyInfo(Variant::INT, "faction", PROPERTY_HINT_ENUM, "Neutral,Friendly,Hostile"), "set_faction", "get_faction");
	...
	ClassDB::bind_method(D_METHOD("set_health_regen", "regen"), &Character::set_health_regen);
	ClassDB::bind_method(D_METHOD("get_health_regen"), &Character::get_health_regen);
	ADD_PROPERTY(PropertyInfo(Variant::FLOAT, "health_regen"), "set_health_regen", "get_health_regen");

	ClassDB::bind_method(D_METHOD("get_health_percent"), &Character::get_health_percent);
	ClassDB::bind_method(D_METHOD("is_alive"), &Character::is_alive);
	ClassDB::bind_method(D_METHOD("is_full_health"), &Character::is_full_health);

	// === 法力系统 ===
	ClassDB::bind_method(D_METHOD("set_mana", "mana"), &Character::set_mana);
	ClassDB::bind_method(D_METHOD("get_mana"), &Character::get_mana);
	ADD_PROPERTY(PropertyInfo(Variant::FLOAT, "mana"), "set_mana", "get_mana");

	ClassDB::bind_method(D_METHOD("set_max_mana", "max_mana"), &Character::set_max_mana);
	ClassDB::bind_method(D_METHOD("get_max_mana"), &Character::get_max_mana);
	ADD_PROPERTY(PropertyInfo(Variant::FLOAT, "max_mana"), "set_max_mana", "get_max_mana");

	ClassDB::bind_method(D_METHOD("set_mana_regen", "regen"), &Character::set_mana_regen);
	ClassDB::bind_method(D_METHOD("get_mana_regen"), &Character::get_mana_regen);
	ADD_PROPERTY(PropertyInfo(Variant::FLOAT, "mana_regen"), "set_mana_regen", "get_mana_regen");

	ClassDB::bind_method(D_METHOD("get_mana_percent"), &Character::get_mana_percent);
	ClassDB::bind_method(D_METHOD("has_mana", "amount"), &Character::has_mana);
	ClassDB::bind_method(D_METHOD("consume_mana", "amount"), &Character::consume_mana);

	// === 基础属性 ===
	ClassDB::bind_method(D_METHOD("set_move_speed", "speed"), &Character::set_move_speed);
	...
	ClassDB::bind_method(D_METHOD("set_attack_damage", "damage"), &Character::set_attack_damage);
	ClassDB::bind_method(D_METHOD("get_attack_damage"), &Character::get_attack_damage);
	ADD_PROPERTY(PropertyInfo(Variant::FLOAT, "attack_damage"), "set_attack_damage", "get_attack_damage");

	ClassDB::bind_method(D_METHOD("set_attack_speed", "speed"), &Character::set_attack_speed);
	ClassDB::bind_method(D_METHOD("get_attack_speed"), &Character::get_attack_speed);
	ADD_PROPERTY(PropertyInfo(Variant::FLOAT, "attack_speed"), "set_attack_speed", "get_attack_speed");

	ClassDB::bind_method(D_METHOD("set_armor", "armor"), &Character::set_armor);
	ClassDB::bind_method(D_METHOD("get_armor"), &Character::get_armor);
	ADD_PROPERTY(PropertyInfo(Variant::FLOAT, "armor"), "set_armor", "get_armor");

	ClassDB::bind_method(D_METHOD("set_magic_resist", "resist"), &Character::set_magic_resist);
	ClassDB::bind_method(D_METHOD("get_magic_resist"), &Character::get_magic_resist);
	ADD_PROPERTY(PropertyInfo(Variant::FLOAT, "magic_resist"), "set_magic_resist", "get_magic_resist");

	// === 状态系统 ===
	ClassDB::bind_method(D_METHOD("set_state_flags", "flags"), &Character::set_state_flags);
	ClassDB::bind_method(D_METHOD("get_state_flags"), &Character::get_state_flags);
	ADD_PROPERTY(PropertyInfo(Variant::INT, "state_flags"), "set_state_flags", "get_state_flags");

	ClassDB::bind_method(D_METHOD("add_state", "state"), &Character::add_state);
	ClassDB::bind_method(D_METHOD("remove_state", "state"), &Character::remove_state);
	ClassDB::bind_method(D_METHOD("has_state", "state"), &Character::has_state);
	ClassDB::bind_method(D_METHOD("clear_states"), &Character::clear_states);

	ClassDB::bind_method(D_METHOD("can_move"), &Character::can_move);
	ClassDB::bind_method(D_METHOD("can_attack"), &Character::can_attack);
	ClassDB::bind_method(D_METHOD("can_cast"), &Character::can_cast);
	ClassDB::bind_method(D_METHOD("is_invincible"), &Character::is_invincible);
	...
	// === 战斗系统 ===
	ClassDB::bind_method(D_METHOD("take_damage", "amount", "type", "source"), &Character::take_damage, DEFVAL(DAMAGE_TYPE_PHYSICAL), DEFVAL(Variant()));
	ClassDB::bind_method(D_METHOD("heal", "amount", "source"), &Character::heal, DEFVAL(Variant()));
	ClassDB::bind_method(D_METHOD("die", "killer"), &Character::die, DEFVAL(Variant()));
	ClassDB::bind_method(D_METHOD("respawn", "health_percent"), &Character::respawn, DEFVAL(1.0f));
	ClassDB::bind_method(D_METHOD("calculate_damage_reduction", "damage", "type"), &Character::calculate_damage_reduction);

	// === 时间更新 ===
	ClassDB::bind_method(D_METHOD("tick", "delta"), &Character::tick);

	// === 虚函数绑定 ===
	GDVIRTUAL_BIND(_on_take_damage, "damage", "type", "source");
	GDVIRTUAL_BIND(_on_heal, "amount", "source");
	GDVIRTUAL_BIND(_on_death, "killer");
	GDVIRTUAL_BIND(_on_respawn);
	GDVIRTUAL_BIND(_on_level_up, "new_level");
}
